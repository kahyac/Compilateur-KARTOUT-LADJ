...
public final class AExpression2Expression extends PExpression
{
    private PExpression2 _expression2_;

    public AExpression2Expression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpression2Expression(
    ...
    {
        ((Analysis) sw).caseAExpression2Expression(this);
    }
