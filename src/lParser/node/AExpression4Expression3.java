...
public final class AExpression4Expression3 extends PExpression3
{
    private PExpression4 _expression4_;

    public AExpression4Expression3()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpression4Expression3(
    ...
    {
        ((Analysis) sw).caseAExpression4Expression3(this);
    }
