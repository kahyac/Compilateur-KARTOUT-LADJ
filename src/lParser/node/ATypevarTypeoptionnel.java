...
public final class ATypevarTypeoptionnel extends PTypeoptionnel
{
    private PTypevar _typevar_;

    public ATypevarTypeoptionnel()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ATypevarTypeoptionnel(
    ...
    {
        ((Analysis) sw).caseATypevarTypeoptionnel(this);
    }
