...
public class DepthFirstAdapter extends AnalysisAdapter
{
    ...
    public void inAExpressioncarreExpression6(AExpressioncarreExpression6 node)
    {
        defaultIn(node);
    }

    public void outAExpressioncarreExpression6(AExpressioncarreExpression6 node)
    {
        defaultOut(node);
    }

    @Override
    public void caseAExpressioncarreExpression6(AExpressioncarreExpression6 node)
    {
        inAExpressioncarreExpression6(node);
        if(node.getExpressioncarre() != null)
        {
            node.getExpressioncarre().apply(this);
        }
        outAExpressioncarreExpression6(node);
    }

    public void inACarreExpressioncarre(ACarreExpressioncarre node)
    {
        defaultIn(node);
    }

    public void outACarreExpressioncarre(ACarreExpressioncarre node)
    {
        defaultOut(node);
    }
    ...
    public void inAExpression7Expressioncarre(AExpression7Expressioncarre node)
    {
        defaultIn(node);
    }

    public void outAExpression7Expressioncarre(AExpression7Expressioncarre node)
    {
        defaultOut(node);
    }

    @Override
    public void caseAExpression7Expressioncarre(AExpression7Expressioncarre node)
    {
        inAExpression7Expressioncarre(node);
        if(node.getExpression7() != null)
        {
            node.getExpression7().apply(this);
        }
        outAExpression7Expressioncarre(node);
    }
